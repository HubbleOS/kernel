...
#define E1000_DEVICE_ID 0x100E // e1000 for QEMU

// Registers e1000 (offsets from BAR0)
...
#define E1000_CTRL_LOOP (1 << 8) // Loopback Mode

#define E1000_RAL0 0x5400 // MAC address, low 4 bytes
#define E1000_RAH0 0x5404 // MAC address, high 2 bytes + valid bit
...
#define E1000_TCTL_COLD (0x040 << 12) // Collision Distance
