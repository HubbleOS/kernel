...
/**
 * @brief Kernel error codes (POSIX-compatible).
 */
...
#define ELNRNG          48  /* Line number out of range              */
...
#define ELIBBAD         80  /* Accessing corrupted shared library    */
#define ELIBSCN         81  /* .lib section corrupted                */
#define ELIBMAX         82  /* Too many shared libraries             */
#define ELIBEXEC        83  /* Cannot exec shared library directly   */
#define EILSEQ          84  /* Invalid multibyte character           */
#define ERESTART        85  /* Interrupted syscall should restart    */
...
#define EKEYREJECTED    129 /* Key was rejected                      */
#define EOWNERDEAD      130 /* Owner died                            */
#define ENOTRECOVERABLE 131 /* State not recoverable                 */
#define ERFKILL         132 /* Operation blocked by RF-kill          */
