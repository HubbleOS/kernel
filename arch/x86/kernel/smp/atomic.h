 ...
 */
static inline uint32_t atomic_read(atomic_t *a) { return a->value; }
 ...
 */
static inline void atomic_set(atomic_t *a, uint32_t val) { a->value = val; }
 ...
 */
static inline bool atomic_cmpxchg(atomic_t *a, uint32_t old_val,
                                  uint32_t new_val) {
 ...
 * @return Current value
 */
static inline uint64_t atomic64_read(atomic64_t *a) { return a->value; }
 ...
 * @param val Value to set
 */
static inline void atomic64_set(atomic64_t *a, uint64_t val) { a->value = val; }
