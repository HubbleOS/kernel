...
typedef void (*acpi_lapic_callback_t)(uint8_t apic_id, uint8_t processor_id,
                                      void *ctx);
typedef void (*acpi_ioapic_callback_t)(uint8_t ioapic_id, uint32_t address,
                                       uint32_t gsi_base, void *ctx);
typedef void (*acpi_iso_callback_t)(uint8_t irq_source, uint32_t gsi,
                                    uint16_t flags, void *ctx);
typedef void (*acpi_mcfg_callback_t)(uint64_t base_addr, uint16_t segment,
