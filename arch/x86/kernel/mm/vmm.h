...
// #define PTE_PS (1ULL << 7) // Page Size (для больших страниц)
// #define PTE_GLOBAL (1ULL << 8)
// #define PTE_NX (1ULL << 63)

// // Higher-half kernel base
// // Например, kernel mapped at -2GB (0xFFFFFFFF80000000)
...
// ИСПРАВЛЕНО: добавлены параметры heap
...
// Bootstrap allocator для инициализации
