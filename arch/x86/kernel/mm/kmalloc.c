 ...
 *
 * Provides the standard kmalloc/kfree/krealloc API on top of the slab
 * allocator for small allocations and the PMM for large allocations.
 */
...
/**
 * @brief Acquire the kmalloc spinlock and disable interrupts
 *
...
/**
 * @brief Release the kmalloc spinlock and restore interrupts
 *
 ...
 *
 * Uses the slab allocator for objects up to SLAB_MAX_SIZE and the PMM for
 * larger allocations.
 *
 ...
 *
 * Determines whether the pointer belongs to the slab allocator or is a
 * large PMM allocation, and frees accordingly.
 *
